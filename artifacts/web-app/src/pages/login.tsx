      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white relative">
        <div className="w-full max-w-md space-y-10 animate-fade-in">
          ...
          <div className="space-y-4 flex justify-center">
            <a
              href="/api/login"
              className="flex items-center justify-center gap-3 w-full px-6 py-3 border border-slate-300 rounded-md bg-white text-slate-700 font-medium hover:bg-slate-50 transition-colors shadow-sm"
            >
